...
*[这里放置搜索结果页面截图，展示找到的相似文件列表和相似度评分]*
...
*[这里放置一组对比截图，展示同一个查询在不同搜索模式下的结果差异]*
